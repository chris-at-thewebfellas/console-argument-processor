...
class ArgumentsUsagePrinterSpec extends Specification {
    ...
    def 'fetch with required default'() {
        ...
        then:
        outputMessage == """Usage:
[crx default: 'http://test-publisher01.wgsn.com:7503/crx/server']
"""
    }
    ...
    def 'fetch with default'() {
        ...
        given:
        Map knownArgs = [
                'crx': [required: true, defaultValue: 'http://test-publisher01.wgsn.com:7503/crx/server']
        ]
        ...
        then:
        outputMessage == """Usage:
[crx required default: 'http://test-publisher01.wgsn.com:7503/crx/server']
"""
    }
